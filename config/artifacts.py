...
config_lib.DEFINE_list(
    ...
    [
        os.path.normpath(f"{os.path.dirname(__file__)}/../../grr/artifacts"),
        os.path.normpath(
            f"{os.path.dirname(__file__)}/../../grr/artifacts/flow_templates"
        ),
        os.path.normpath(
            os.path.dirname(__file__) + "/../../grr/artifacts/local"
        ),
    ],
